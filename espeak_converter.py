    ...
    while True:
        try:
            if url.lower().startswith('file://'):
                ...
                r = session.post('https://downloader.danstiv.ru', json={'url': url, 'headers': {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.80 Safari/537.36'}}, timeout=300)
